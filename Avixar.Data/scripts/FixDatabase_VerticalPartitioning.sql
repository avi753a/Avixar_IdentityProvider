/*
 * SCRIPT: FixDatabase_VerticalPartitioning.sql
 * PURPOSE: Implements the Vertical Partitioning schema (Users + UserSecrets).
 *          Fixes the "duplicate table name" error by renaming the secrets table.
 */
...
DROP TABLE IF EXISTS "user_secrets" CASCADE; -- The new name
...
-- USER SECRETS (Encrypted PII)
CREATE TABLE "user_secrets" (
    -- Shared Key: PK is also FK to users.Id
...
-- sp_CreateUser (Split Table + Upsert Logic)
...
-- sp_SocialLogin (Split Table Logic)
